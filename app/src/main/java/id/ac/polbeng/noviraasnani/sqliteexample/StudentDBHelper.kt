package id.ac.polbeng.noviraasnani.sqliteexample
...
class StudentDBHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DBContract.UserEntry.TABLE_NAME + " (" + DBContract.UserEntry.COLUMN_NIM + " TEXTPRIMARYKEY," +
    ...
    fun createStudent(student: StudentModel): Long {
        ...
        // Insert the new row, returning the primary key value of the new row
                return db.insert(DBContract.UserEntry.TABLE_NAME,
                    null,
                    values)
    }
